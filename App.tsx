...
import { generateLocationData, generate360View, analyzeVideo, transcribeAudio, generateSpeech, complexReasoning, processVoiceCommand } from './services/geminiService';
        ...
        <section className="flex-1 relative overflow-hidden bg-black flex items-center justify-center">
          ...
          {viewUrl ? (
            ...
            >
              ...
              <div className="absolute inset-0 flex transition-transform duration-500 ease-out" style={{ transform: `translateX(-${scrollPos}%)` }} >
